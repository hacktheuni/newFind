...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = '22amtics461@gmail.com'
EMAIL_HOST_PASSWORD = 'xfts qzli ytro kchn'
DEFAULT_FROM_EMAIL = '22amtics461@gmail.com'

# Caching configuration (example using Redis)
CACHES = {
    'default': {
